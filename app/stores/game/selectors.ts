...
export const isGameEnded = (currentSceneId: string, gameEndSceneId: string): boolean =>
  currentSceneId === gameEndSceneId;
...
export const isFirstDialogueOfInitialScene = (
  ...
  currentSceneId === initialSceneId && currentDialogueIndex === 0;
